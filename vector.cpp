...
Hart<URV>::vsetvl(unsigned rd, unsigned rs1, URV vtypeVal, bool vli /* vsetvli instruction*/)
{
  ...
  bool altfmt = (isRvzvfofp8min() or isRvzvfbfa() or isRvzvfwdota16bf() or isRvzvfwbdota16bf() or isRvzvfqwbdota8f()) and ((vtypeVal >> 8) & 1);
  ...
  // Only least sig 8 bits can be non-zero unless Zvfbfa/Zvfofp8min/Zvfwdota16bf/Zvfwbdota16bf/Zvfqwbdota8f
...
Hart<URV>::execVsetivli(const DecodedInst* di)
{
  ...
  bool altfmt = (isRvzvfofp8min() or isRvzvfbfa() or isRvzvfwdota16bf() or isRvzvfwbdota16bf() or isRvzvfqwbdota8f()) and ((imm >> 8) & 1);
