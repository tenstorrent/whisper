...
Hart<URV>::execVfmul_vv(const DecodedInst* di)
{
  ...
  switch (sew)
    ...
    case EW::Half:
      if (bf16_)
        vfmul_vv<BFloat16>(vd, vs1, vs2, group, start, elems, masked);
      else
        vfmul_vv<Float16>(vd, vs1, vs2, group, start, elems, masked);
      break;
...
Hart<URV>::execVfdiv_vv(const DecodedInst* di)
{
  ...
  switch (sew)
    ...
    case EW::Half:
      if (bf16_)
        vfdiv_vv<BFloat16>(vd, vs1, vs2, group, start, elems, masked);
      else
        vfdiv_vv<Float16>(vd, vs1, vs2, group, start, elems, masked);
      break;
...
Hart<URV>::execVfdiv_vf(const DecodedInst* di)
{
  ...
  switch (sew)
    ...
    case EW::Half:
      if (bf16_)
        vfdiv_vf<BFloat16>(vd, vs1, rs2, group, start, elems, masked);
      else
...
Hart<URV>::execVfrdiv_vf(const DecodedInst* di)
{
  ...
  switch (sew)
    ...
    case EW::Half:
      if (bf16_)
        vfrdiv_vf<BFloat16>(vd, vs1, rs2, group, start, elems, masked);
      else
...
Hart<URV>::execVfsqrt_v(const DecodedInst* di)
{
  ...
  switch (sew)
    ...
    case EW::Half:
      if (bf16_)
        vfsqrt_v<BFloat16>(vd, vs1, group, start, elems, masked);
      else
